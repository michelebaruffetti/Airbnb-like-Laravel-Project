        ...
        <div class="col-12">
            ...
            <form action="{{ route('admin.apartments.update', ['apartment' => $apartment->id] )}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="title" class="form-control w-50" id="titolo" placeholder="Titolo inserzione" value="{{ old('title', $apartment->title) }}">
                </div>
                <div class="form-group">
                    <label for="testo">Descrizione</label>
                    <textarea type="text" name="description" class="form-control w-50" id="testo" placeholder="Inserisci descrizione dell'appartamento...">{{ old('description', $apartment->description) }}</textarea>
                </div>

                <!-- form indirizzo -->
                <div class="form-group">
                    <label for="form-address">Indirizzo</label>
                    <input type="search" class="form-control w-50" id="form-address" name="address" value="{{old('address', $apartment->address)}}" placeholder="Inserisci il tuo indirizzo">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="square_meters" class="form-control w-50" id="mq" placeholder="Inserisci le dimensioni in mq dell'appartamento..." value="{{ old('square_meters', $apartment->square_meters) }}">
                </div>
                <div class="form-group">
