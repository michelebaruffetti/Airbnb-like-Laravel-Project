<!-- Footer -->
<footer class="page-footer font-small mdb-color pt-4" id="selettore-footer">
        ...
        <div class="row text-center text-md-left mt-3 pb-3">
          ...
          <!-- Grid column -->
            ...
            <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mt-3">
                ...
                <p>
                    <a href="#!">Abilità e sicurezza</a>
                </p>
                <p>
                    <a href="#!">Servizio di assistenza</a>
                </p>
            </div>
            ...
            <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
                ...
                <p>
                    <i class="fas fa-home mr-3"></i> Roma, RM 00164, IT</p>
                <p>
    ...
    <!-- Footer links -->
        ...
        <div class="row d-flex align-items-center">
            ...
            <div class="col-md-7 col-lg-8">
                ...
                <!--Copyright-->
                <p class="text-center text-md-left">© 2020 BoolB&B,
                    <a href="#">
                        <strong> Inc. All rights reserved</strong>
                    </a>
                </p>
